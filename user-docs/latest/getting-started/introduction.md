...
If your Strapi application was configured to allow authentication through SSO (Single Sign On), you can access the admin panel using a specific provider instead of logging in with a regular Strapi account.
