...
Strapi plugins can register additional MCP tools, resources, and prompts through the `strapi.ai.mcp` service, so AI clients can trigger plugin-specific actions. Click on the card below to read more details:
