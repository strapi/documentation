...
The current page still describes the stable version of the Media Library. Over the next few weeks, the documentation will be updated to reflect the new features. In the meantime, there is a <ExternalLink text="work-in-progress documentation" to="https://documentation-git-cms-media-library-beta-ui-docs-strapijs.vercel.app/cms/features/media-library" /> available and you can <ExternalLink text="read more about the future features here" to="https://strapi.notion.site/Media-Library-Beta-Release-3c78f3598074810dbad6f2addfa25b6f" />.
:::
