...
<IdentityCard>
  <IdentityCardItem icon="credit-card" title="Plan">Preview is a free feature.<br/>Live Preview is available only with the CMS Growth and Enterprise plans.</IdentityCardItem>
