...
| `description`    | The field description set in [configure the view](/cms/features/content-manager#configuring-the-edit-view)                                                                                                  | [`IntlObject`](https://formatjs.io/docs/react-intl/)                 |
| `placeholder`    | The field placeholder set in [configure the view](/cms/features/content-manager#configuring-the-edit-view)                                                                                                  | [`IntlObject`](https://formatjs.io/docs/react-intl/)                 |
| `hint`           | The field description set in [configure the view](/cms/features/content-manager#configuring-the-edit-view) along with min/max [validation requirements](/cms/backend-customization/models#validations) | `String`                                                             |
