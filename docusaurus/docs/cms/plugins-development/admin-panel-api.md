...
| Create a new settings section            | [`addSettingsLink()`](/cms/plugins-development/admin-navigation-settings#creating-a-new-settings-section) (with a section object) | [`register()`](#register)   |
| Add one or several links to a settings section | [`addSettingsLink()`](/cms/plugins-development/admin-navigation-settings#adding-links-to-existing-settings-sections) (with a section id) | [`bootstrap()`](#bootstrap) |
