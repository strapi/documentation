...
<CustomDocCard icon="feather" title="MCP server" description="Learn how to enable, configure, and connect to Strapi's built-in MCP server." link="/cms/features/strapi-mcp-server" />
