...
Strapi maintains 3 providers for the Media Library. The present page is about the <ExternalLink to="https://cloudinary.com/" text="Cloudinary" /> provider installation and configuration. For other providers, please refer to the list in the [Media Library Providers page](/cms/features/media-library#providers).
