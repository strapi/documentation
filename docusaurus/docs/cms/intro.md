...
:::tip Need help?
Customers on paid plans can reach the Strapi team through the <ExternalLink to="https://support.strapi.io/" text="Strapi Support platform"/>. Community users can ask questions on <ExternalLink to="https://github.com/strapi/strapi/discussions" text="GitHub Discussions"/> or <ExternalLink to="https://discord.strapi.io" text="Discord"/>.
:::
