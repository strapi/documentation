...
Strapi 5 uses <ExternalLink to="https://www.npmjs.com/package/react-router-dom" text="`react-router-dom`"/> v6. This impacts the links added to [settings](/cms/plugins-development/admin-configuration-customization#settings) or to the [menu](/cms/plugins-development/admin-configuration-customization#navigation-sidebar-menu-links) using the Admin Panel API.
...
Ensure that links added to [settings](/cms/plugins-development/admin-configuration-customization#settings) or to the [menu](/cms/plugins-development/admin-configuration-customization#navigation-sidebar-menu-links) links using the Admin Panel API use relative paths.
