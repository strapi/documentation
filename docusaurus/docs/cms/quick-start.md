...
:::strapi Try the hosted demo
Strapi offers a [hosted demo](https://strapi.io/demo) so you can quickly try its [Content Manager](/cms/features/content-manager) and learn how to edit content. In this hosted demo, the Content-Type Builder is [disabled by design](/cms/faq#why-cant-i-create-or-update-content-types-in-productionstaging). 
:::
