...
In the meantime, we encourage you to read the [GraphQL API](/cms/api/graphql) section, which is already up-to-date with Strapi 5.
:::
...
Using [React](/cms/integrations/react.md) and [Apollo](https://www.apollographql.com/)
...
Using [Vue.js](/cms/integrations/vue-js.md) and [Apollo](https://www.apollographql.com/)
