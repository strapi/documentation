...
<Endpoint
  id="find-users-eq"
  method="GET"
  path="/api/users?filters[username][$eq]=John"
  codePath="/api/users?filters[username][$eq]=John"
  title="Find users having 'John' as first name"
  description="Use the $eq filter operator to find an exact match."
  codeTabs={[
    {
      label: 'cURL',
      code: `GET /api/users?filters[username][$eq]=John`,
    },
    {
      label: 'JavaScript',
...
<Endpoint
  id="find-restaurants-in"
  method="GET"
  path="/api/restaurants?filters[id][$in][0]=3&filters[id][$in][1]=6&filters[id][$in][2]=8"
  codePath="/api/restaurants?filters[id][$in][0]=3&filters[id][$in][1]=6&filters[id][$in][2]=8"
  title="Find multiple restaurants with ids 3, 6, 8"
  description="Use the $in filter operator with an array of values to find multiple exact values."
  codeTabs={[
    {
      label: 'cURL',
      code: `GET /api/restaurants?filters[id][$in][0]=3&filters[id][$in][1]=6&filters[id][$in][2]=8`,
    },
    {
      label: 'JavaScript',
      code: `const qs = require('qs');
...
<Endpoint
  method="GET"
  path="/api/books?filters[$and][0][$or][0][date][$eq]=2020-01-01&filters[$and][0][$or][1][date][$eq]=2020-01-02&filters[$and][1][author][name][$eq]=Kai%20doe"
  codePath="/api/books?filters[$and][0][$or][0][date][$eq]=2020-01-01&filters[$and][0][$or][1][date][$eq]=2020-01-02&filters[$and][1][author][name][$eq]=Kai%20doe"
  title="Find books with 2 possible dates and a specific author"
  description="Combine $and and $or operators for complex filtering."
  codeTabs={[
    {
      label: 'cURL',
      code: `GET /api/books?filters[$and][0][$or][0][date][$eq]=2020-01-01&filters[$and][0][$or][1][date][$eq]=2020-01-02&filters[$and][1][author][name][$eq]=Kai%20doe`,
    },
    {
      label: 'JavaScript',
      code: `const qs = require('qs');
...
<Endpoint
  method="GET"
  path="/api/restaurants?filters[chef][restaurants][stars][$eq]=5"
  codePath="/api/restaurants?filters[chef][restaurants][stars][$eq]=5"
  title="Find restaurants owned by a chef who belongs to a 5-star restaurant"
  description="Use deep filtering to filter on a relation's fields."
  codeTabs={[
    {
      label: 'cURL',
      code: `GET /api/restaurants?filters[chef][restaurants][stars][$eq]=5`,
    },
    {
      label: 'JavaScript',
      code: `const qs = require('qs');
