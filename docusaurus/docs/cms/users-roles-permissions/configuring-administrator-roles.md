...
:::note
Other custom conditions can be available if they have been created beforehand for your Strapi application (see [Role-Based Access Control](/cms/configurations/guides/rbac)).
:::
