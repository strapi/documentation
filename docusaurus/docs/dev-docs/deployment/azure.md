...
3. Create a Web App running Node.js 20.

   ```bash
   webAppName=my-strapi-app
   az webapp create --resource-group $rgName --name $webAppName --plan $appPlanName --runtime "node|20-lts"
   ```
