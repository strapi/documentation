...
:::note
If you add a path to the `url` option, it won't prefix your application. To do so, use a proxy server like Nginx (see [additional deployment resources](/dev-docs/deployment#additional-resources)).
:::
