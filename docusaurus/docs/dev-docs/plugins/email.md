...
The Email plugin requires a provider and a provider configuration in the `plugins.js` file or `plugins.ts` file. See the [Providers](/dev-docs/providers) documentation for detailed installation and configuration instructions.
