...
:::caution
Starting with Strapi 5, the platform includes a [Plugin SDK](https://github.com/strapi/sdk-plugin) to help develop and build Strapi plugins. While you are free to use other methods for plugin development, we strongly recommend using the Plugin SDK. As part of the migration process from v4 to v5, we encourage you to update your plugin to take advantage of the Plugin SDK.
:::
