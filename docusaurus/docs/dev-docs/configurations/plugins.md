...
Plugin configurations are stored in `./config/plugins.js` (see [project structure](/dev-docs/file-structure.md)). Each plugin can be configured with the following available parameters:

| Parameter                  | Description                                                                                                                                                            | Type    |
| -------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- |
| `enabled`                  | Enable (`true`) or disable (`false`) an installed plugin                                                                                                               | Boolean |
| `config`<br/><br/>_Optional_ | Used to override default plugin configuration ([defined in strapi-server.js](/dev-docs/api/plugins/server-api.md#configuration)) | Object  |
...
The [GraphQL plugin](/dev-docs/plugins/graphql.md) has the following specific configuration options that should be declared in a `graphql.config` object. All parameters are optional:
...
| `defaultLimit` | Default value for [the `pagination[limit]` parameter](/dev-docs/api/graphql.md#pagination-by-offset) used in API calls | Integer | 100 |
...
| `maxLimit`         | Maximum value for [the `pagination[limit]` parameter](/dev-docs/api/graphql.md#pagination-by-offset) used in API calls                                                                                                              | Integer  | `-1`    |
...
| `shadowCRUD`       | Whether type definitions for queries, mutations and resolvers based on models should be created automatically (see [Shadow CRUD documentation](/dev-docs/plugins/graphql.md#shadow-crud)). | Boolean | `true` |
