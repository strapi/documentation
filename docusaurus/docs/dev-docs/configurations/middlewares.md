...
| Plugin            | Exported from `strapi-server.js` in the [`middlewares` property of the plugin interface](/dev-docs/plugin-development/server-api.md#middlewares)                                                                                               | `plugin::plugin-name.middleware-name`                                                                                |
