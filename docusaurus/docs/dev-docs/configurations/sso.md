...
description: Strapi's SSO allows you to configure additional sign-in and sign-up methods for your administration panel. It requires a paid Strapi plan that includes SSO.
...
- To configure SSO on your application, you will need a paid Strapi plan that includes SSO. Please refer to the [pricing page](https://strapi.io/pricing-self-hosted) for more information.
