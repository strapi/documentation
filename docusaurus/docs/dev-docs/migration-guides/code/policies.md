...
Strapi v3 policies acting as route middlewares should be converted to proper [v4 route middlewares](/dev-docs/migration-guides/code/route-middlewares).
:::
...
1. Move the policy file in the appropriate folder, depending on the policy scope:
    ...
    | A specific plugin | `./src/plugins/<plugin-name>/policies`<br/><br/>(see [plugin policies migration](/dev-docs/migration-guides/plugin/update-folder-structure#moving-policies) documentation) |
