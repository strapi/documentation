...
This front-end code migration overview is part of the [v4 code migration guide](/dev-docs/migration-guides/code-migration).
...
:::prerequisites
Make sure to entirely [migrate the back end](/dev-docs/migration-guides/code/backend) before migrating the front end.
:::
...
- [WYSIWYG customizations](/dev-docs//migration-guides/code/wysiwyg)
- [translations](/dev-docs/migration-guides//code/translations)
- [webpack configuration](/dev-docs/migration-guides/code/webpack)
- [theme customizations](/dev-docs/migration-guides/code/theming)
- [calls to the `strapi` global variable](/dev-docs/migration-guides/code/strapi-global) (e.g. to handle notifications and freeze user interactions)
...
- Another difference between Strapi v3 and v4 is that the configuration of the admin panel in Strapi v4 is declared in a specific `./config/admin.js` configuration file (see [admin panel configuration migration](/dev-docs/migration-guides/code/configuration#admin-panel-configuration).
