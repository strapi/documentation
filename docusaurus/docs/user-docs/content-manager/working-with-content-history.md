...
1. While editing a document in the Content Manager, click on <Icon name="dots-three-outline" /> at the top right of the interface, and click the ![ClockCounterClockwise icon](/img/assets/icons/v5/ClockCounterClockwise.svg) **Content History** button.
