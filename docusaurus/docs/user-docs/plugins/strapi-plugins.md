...
- Some plugin options are only available with an [Enterprise edition license](https://strapi.io/pricing-self-hosted), and are marked with  <EntrepriseBadge link="https://strapi.io/pricing-self-hosted"/> in this reference guide.
...
:::note
[API tokens](/user-docs/settings/managing-global-settings#managing-api-tokens) are the preferred method for managing end users. Strapi plans to remove the Users & Permissions plugin from the default installation by the end of September 2022.
:::
