...
- Some plugin options are only available with an [Enterprise edition license](https://strapi.io/pricing-self-hosted), and are marked with  <EnterpriseBadge link="https://strapi.io/pricing-self-hosted"/> in this reference guide.
