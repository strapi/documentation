...
| Section impacted    | Options and settings         |
|------------|-----------------|
| Settings     |  Addition of a "Gatsby preview plugin" setting section, enables/disables collection types and single types, and allows the Gatsby Content Sync URL to be added. <br/><Icon name="arrow-fat-right" /> Path reminder: ![Settings icon](/img/assets/icons/v5/Cog.svg) *Settings > Gatsby preview plugin* | |
