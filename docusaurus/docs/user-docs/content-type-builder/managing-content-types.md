...
* **Review workflows**: Enable the [review workflow](/user-docs/settings/review-workflows) <EnterpriseBadge /> <BetaBadge /> feature for the content-type or component. It is disabled by default.
