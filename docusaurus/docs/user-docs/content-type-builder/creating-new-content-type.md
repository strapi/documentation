...
2. In the component creation window, configure the base settings of the new component:
   ...
   - Choose an icon to represent the new component. You can use the search ![Search icon](/img/assets/icons/search.svg) to find an icon instead of scrolling through the list.
