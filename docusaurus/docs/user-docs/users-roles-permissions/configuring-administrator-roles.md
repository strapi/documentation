...
| Review Workflows | <ul><li>General</li><ul><li>"Access the Review workflows settings page"</li></ul></ul> 👉 Path reminder to Review workflows settings: <br /> *General > Settings > Global Settings - Review workflows* |
