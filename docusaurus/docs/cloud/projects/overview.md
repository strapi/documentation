...
- switch or add an environment <ScreenshotNumberReference number="1" />,
...
- use the <Icon name="gear-six" /> **Settings** button to access the settings of the project and its existing environments <ScreenshotNumberReference number="3" />,
- navigate between deployments (see [Deployments history](/cloud/projects/deploys-history)), logs (see [Logs](/cloud/projects/logs)) and observability (see [Observability](/cloud/projects/observability)) <ScreenshotNumberReference number="4" />,
