  ...
  themeConfig:
    ...
    ({
      announcementBar: {
        id: 'support_us',
        content:
          "Don't panic! Strapi 5 is out, but Strapi v4 is still supported until March 2026. Strapi v4 docs are now hosted at <a target='_blank' rel='noopener noreferrer' href='https://docs-v4.strapi.io'>docs-v4.strapi.io</a>.",
