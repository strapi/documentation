...
const config = {
  ...
  noIndex: true, // remove for docs.strapi.io
  ...
  scripts: [
    ...
    },
    {
      ...
      // 'data-user-analytics-fingerprint-enabled': 'true', // TODO: enable for production on docs.strapi.io
    ...
    [
      ...
      /** @type {import('@docusaurus/preset-classic').Options} */
      {
        docs: {
          ...
          editUrl: 'https://github.com/strapi/documentation/edit/v6/main/docusaurus', // TODO change back to next then main for production releases
          admonitions: {
            keywords: [
