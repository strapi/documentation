      ...
      <Tabs>
        ...
        <TabItem value="js" label="JavaScript-based plugins">
          ...
          <pre className="prism-code">
            ...
            │   │   ├── <a href="/dev-docs/plugins/server-api#register">destroy.js</a> <span className="token comment"># Function that is called to clean up the plugin after Strapi instance is destroyed</span><br/>
            │   │   ├── <a href="/dev-docs/plugins/server-api">index.js</a> <span className="token comment"># Entrypoint for the server (back end)</span> <br />
