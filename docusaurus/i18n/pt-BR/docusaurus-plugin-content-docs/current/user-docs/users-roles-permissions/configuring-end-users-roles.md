...
![End-users roles interface](/img/assets/users-permissions/end-user_roles.png)
...
![Configuring a role for end users](/img/assets/users-permissions/end-user_roles-config.png)
