...
Description: <!-- #### Find ‘fr’ version of all documents with fallback on default (en)
...
Description: For example, to install the AWS S3 provider for the Upload (Media Library) feature::
...
Description: The following is an example configuration for an AWS S3 Media Library provider:
(Source: https://docs.strapi.io/cms/configurations/media-library-providers#configuring-providers)
...
## Private providers
Description: Create a /providers/aws-s3 folder in your application.
(Source: https://docs.strapi.io/cms/configurations/media-library-providers#private-providers)
