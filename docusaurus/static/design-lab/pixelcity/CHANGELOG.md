# Pixel Docs City — the Golden Shore crossing
...
This world's own new thing is **THE LAMPLIGHTER'S YARD**: the town lights its own
lamps at dusk, and the yard that trims them also keeps the lamps of a coast down
the line, one for every page, each burning at the strength of the days since
somebody tended it. The handcart is loaded and its shaft points west, at the
coast road. And the harbour steamer is gone with the project she was bound for,
berth and wink and all.
...
`qa/r19/lampyard.js` — the courier walked into the yard, the door prompt read by day and again at golden hour, the town sign raised with ENTER, and Escape / N / Tab / a click on the dusk behind the plank all proven safe before Y crosses.
