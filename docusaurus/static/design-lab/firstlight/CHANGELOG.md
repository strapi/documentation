# FIRST LIGHT — the Golden Shore crossing
...
This world's own new thing is **THE SECOND TRACE**: under our own reading, at the
bottom of the same panel, the photometer has always carried a channel it was
never asked for, far to the red of anything we are pointed at, and it is not a
body. It is a staircase, and it does not change while we watch it. It is somebody
else's evening photometry, taken from the ground, at a station whose sun has not
gone down. And the carrier that used to sit in the guard band past C27 is off the
air, with the room it led to.
...
`qa/r19/secondtrace.js` — the second trace shot under the amber one, the poll raised, and Escape / N / Tab proven safe before GO.
