# The Four-Color — the Golden Shore crossing
...
This world's own new thing is **a house ad**: THE GOLDEN SHORE took a page on the
stand like everybody else, in the back matter and never mid-story — ONE WEEK IN
THE LAST HOUR OF LIGHT, with a coupon for the brochure and the tide table. And
BY THE DEEP came off the stand the same day: the picture closed, and the house
does not advertise a title that is out of print.
...
`qa/r19/shoread.js` — the issue whose back matter carries the title found by reading the stand's own pagination, the ad shot, the coupon clipped, and Escape / N / Tab proven safe before Y.
