...
document.addEventListener('DOMContentLoaded', () => {
  ...
  '/user-docs/users-roles-permissions/configuring-end-users-roles': {
      ...
      'auth-zero': '/cms/configurations/users-and-permissions-providers/auth-zero',
      ...
      'discord-config': '/cms/configurations/users-and-permissions-providers/discord',
      'discord-strapi-config': '/cms/configurations/users-and-permissions-providers/discord#strapi-configuration',
