<template>
  <div>
    <!-- API Documentation -->
    <div>
      <InstallLink link="/latest/development/plugins/documentation.html">
        <template #icon>
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="24"><text transform="translate(-20 -6)" fill="#4B515A" fill-rule="evenodd" font-size="30" font-family="AppleColorEmoji, Apple Color Emoji"><tspan x="20" y="31">📖</tspan></text></svg>
        </template>
        <template #title>API Documentation</template>
        <template #description>
          Plugin to generate the API documentation
        </template>
      </InstallLink>
    </div>
    ...
    <!-- Email -->
    <div>
      <InstallLink link="/latest/development/plugins/email.html">
        <template #icon>
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="24"><text transform="translate(-20 -6)" fill="#4B515A" fill-rule="evenodd" font-size="30" font-family="AppleColorEmoji, Apple Color Emoji"><tspan x="20" y="31">✉️</tspan></text></svg>
        </template>
    ...
    <!-- GraphQL -->
    <div>
      <InstallLink link="/latest/development/plugins/graphql.html">
        <template #icon>
        ...
        <template #description>
          Plugin to add GraphQL endpoint with default API methods
        </template>
      </InstallLink>
    </div>
    ...
    <!-- Upload -->
    <div>
      <InstallLink link="/latest/development/plugins/upload.html">
        <template #icon>
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="22"><g fill="none" fill-rule="evenodd"><text font-family="AppleColorEmoji, Apple Color Emoji" font-size="30" fill="#D3E5FF" transform="translate(0 -4)"><tspan x="0" y="30.6">☁️</tspan></text><text font-family="HiraMinProN-W3, Hiragino Mincho ProN" font-size="12" font-weight="300" fill="#768491" transform="translate(0 -4)"><tspan x="9" y="24">⬆︎</tspan></text></g></svg>
        </template>
        <template #title>Upload</template>
        <template #description>
          Plugin to manage media files
        </template>
      </InstallLink>
    </div>
    ...
    <!-- Users & Permissions -->
    <div>
      <InstallLink link="/latest/development/plugins/users-permissions.html">
        <template #icon>
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="24"><text transform="translate(-20 -6)" fill="#4B515A" fill-rule="evenodd" font-size="30" font-family="AppleColorEmoji, Apple Color Emoji"><tspan x="20" y="31">🔐</tspan></text></svg>
        </template>
        <template #title>Users & Permissions</template>
        <template #description>
          Plugin for full authentication process and users management
        </template>
      </InstallLink>
    </div>
