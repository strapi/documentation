...
- Click on **+ Add New Categories** button. Type `French Food` in the **Name** field. Select `Biscotte Restaurant`, on the right from **Restaurant (0)**.
- Click **Save**.
...
- Click on **+ Add New Categories** button. Type `Brunch` in the **Name** field. **DO NOT ADD IT HERE** to `Biscotte Restaurant`.
- Click **Save**.
