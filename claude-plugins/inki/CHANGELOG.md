...
- `COMMANDS.md`: a per-command reference (every skill, its description, and its argument signature), maintained by hand and mirroring each skill's frontmatter. Linked from the README.
