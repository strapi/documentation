...
::: caution
The Documentation plugin documentation may not be fully updated for Strapi v4. Improving the plugin and the documentation is an active project, which should be completed by the end of September 2022.
:::
