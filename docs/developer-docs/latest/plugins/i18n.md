...
- The GraphQL [query API](/developer-docs/latest/plugins/graphql.md#query-api) can be used to:
...
The `locale` field can be passed in the `data` object of the mutation to create a localized entry for this specific locale (for more information, see [create a new entry with the GraphQL plugin](/developer-docs/latest/plugins/graphql.md#create-a-new-entry)).
...
A `locale` argument can be passed in the mutation to update content for a given locale (for more information, see [update an existing entry with the GraphQL plugin](/developer-docs/latest/plugins/graphql.md#update-an-existing-entry)).
