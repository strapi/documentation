...
- The GraphQL [query API](/developer-docs/latest/developer-resources/database-apis-reference/graphql-api.md) can be used to:
  - [query with the `locale` argument](/developer-docs/latest/development/plugins/i18n.md#usage-with-the-graphql-plugin) on collection types and single types
  - [create new localizations with a mutation](/developer-docs/latest/development/plugins/i18n.md#creating-new-localized-entries-with-graphql) for collection types and single types
  - [update](/developer-docs/latest/development/plugins/i18n.md#updating-a-localized-single-type-with-graphql) and [delete](/developer-docs/latest/development/plugins/i18n.md#deleting-a-localization-for-a-single-type-with-graphql) a localization with a mutation on single types
