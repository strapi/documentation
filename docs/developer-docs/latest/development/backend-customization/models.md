...
| `draftAndPublish`   | Boolean          | Enables the draft and publish feature. <br><br> Default value: `true` (`y/N` prompt if the content type is created from the interactive CLI).                                                                                                                                                                                    |
