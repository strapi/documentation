...
The v3 to v4 migration guides are located in the [v4 documentation](https://docs.strapi.io/developer-docs/latest/update-migration-guides/migration-guides.html#v3-to-v4-guides)
:::
