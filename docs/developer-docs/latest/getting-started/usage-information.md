...
- Should we focus our efforts to being compatible with Node 18? Maybe our community uses version 18, in greater percentages than the global Node.js community?
- And more...
