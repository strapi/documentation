...
:::prerequisites
The `cron.enabled` configuration option is set to `true` in [the `./config/server.js` file](/developer-docs/latest/setup-deployment-guides/configurations/required/server.md).
:::
