...
The SSO feature adds a new [authentication event](/developer-docs/latest/setup-deployment-guides/configurations/required/admin.md#available-options): `onSSOAutoRegistration`.
