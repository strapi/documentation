...
<<<<<<< HEAD:developer-docs/latest/concepts/configurations.md
```javascript
module.exports = ({ env }) => ({
  host: env('HOST', '0.0.0.0'),
  port: env.int('PORT', 1337),
...
>>>>>>> 804038fb4172c60874283c999fe997e872a2bb93:docs/developer-docs/latest/setup-deployment-guides/configurations.md
    ],
    after: ['parser', 'router'],
  },
};
