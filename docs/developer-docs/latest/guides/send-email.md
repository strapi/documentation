---
title: Send Email - Strapi Developer Docs
...
In the [controller documentation](/developer-docs/latest/development/backend-customization/controllers.md#extending-core-controllers) you will find the default implementation of every action. It will help you overwrite the create logic.
