...
Relation-type fields added to a content-type from the Content-type Builder allow to establishing a relation with another content-type -mandatory a collection type. These fields are called "relational fields".
