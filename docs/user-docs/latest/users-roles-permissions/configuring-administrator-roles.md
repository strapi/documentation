...
| ----------------------- | ----------- |
| API Tokens | <ul><li>General</li><ul><li>"Create" - allows the creation of API tokens</li><li>"Read" - allows you to see created API tokens (disabling this permission will disable access to the *Global Settings - API Tokens* settings)</li><li>"Update" - allows editing of API tokens</li><li>"Delete" - allows deletion of API tokens</li></ul></ul> 👉 Path reminder to API Tokens settings: <br> *General > Settings > Global Settings - API Tokens* |
