---
title: Configuring administrator roles - Strapi User Guide
description: Instructions to configure roles and permissions for Strapi admin panel administrators
---
