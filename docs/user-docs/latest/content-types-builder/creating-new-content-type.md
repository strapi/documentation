...
Content types are created from the Content-Types Builder's Collection types and Single types categories, both displayed in the Content-Types Builder subnavigation.
...
1. In the Components category of the Content-Types Builder subnavigation, click on **Create a new Component**.
